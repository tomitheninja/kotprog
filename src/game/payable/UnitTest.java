...
class UnitTest {
    ...
    void getInitialHealth() {
        int INIT_HEALTH = 100;
        Unit unit = new Unit("Test unit", 1, 1, INIT_HEALTH, 1, 1, emptyAction);
    ...
    @Test
    void takeDamage() {
        Unit unit = new Unit("Test unit", 1, 1, 5, 1, 1, emptyAction);
    ...
    void testAttack() {
        ...
        Unit unit = new Unit("Test unit", INIT_MIN_ATTACK, INIT_MAX_ATTACK, INIT_HEALTH, 1, 1, emptyAction);
        for (int i = 0; i < 100; i++) {
